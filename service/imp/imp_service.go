...
import (
	...
	"github.com/volcengine/volc-sdk-golang/service/imp/models/response"
)

// SubmitJob
/*
 * @param *request.ImpSubmitJobRequest
 * @return *response.ImpSubmitJobResponse, int, error
 */
func (p *Imp) SubmitJob(req *request.ImpSubmitJobRequest) (*response.ImpSubmitJobResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	...
	respBody, status, err := p.Query("SubmitJob", query)

	output := &response.ImpSubmitJobResponse{}
 ...
 * @return *response.ImpKillJobResponse, int, error
 */
func (p *Imp) KillJob(req *request.ImpKillJobRequest) (*response.ImpKillJobResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("KillJob", query)

	output := &response.ImpKillJobResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
 ...
 * @return *response.ImpRetrieveJobResponse, int, error
 */
func (p *Imp) RetrieveJob(req *request.ImpRetrieveJobRequest) (*response.ImpRetrieveJobResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("RetrieveJob", query)

	output := &response.ImpRetrieveJobResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
