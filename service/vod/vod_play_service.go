...
func (p *Vod) GetAllPlayInfo(req *request.VodGetAllPlayInfoRequest) (*response.VodGetAllPlayInfoResponse, int, error) {
	...
	respBody, status, err := p.Query("GetAllPlayInfo", query)

	output := &response.VodGetAllPlayInfoResponse{}
...
func (p *Vod) DescribeDrmDataKey(req *request.VodDescribeDrmDataKeyRequest) (*response.VodDescribeDrmDataKeyResponse, int, error) {
	...
	respBody, status, err := p.Query("DescribeDrmDataKey", query)

	output := &response.VodDescribeDrmDataKeyResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
