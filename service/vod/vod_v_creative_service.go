 ...
 * @return *response.VodAsyncVCreativeTaskResponse, int, error
 */
func (p *Vod) AsyncVCreativeTask(req *request.VodAsyncVCreativeTaskRequest) (*response.VodAsyncVCreativeTaskResponse, int, error) {
	...
	respBody, status, err := p.Json("AsyncVCreativeTask", url.Values{}, jsonData)

	output := &response.VodAsyncVCreativeTaskResponse{}
 ...
 * @return *response.VodGetVCreativeTaskResultResponse, int, error
 */
func (p *Vod) GetVCreativeTaskResult(req *request.VodGetVCreativeTaskResultRequest) (*response.VodGetVCreativeTaskResultResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("GetVCreativeTaskResult", query)

	output := &response.VodGetVCreativeTaskResultResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
