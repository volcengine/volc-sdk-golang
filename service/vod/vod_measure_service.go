 ...
 * @return *response.DescribeVodRealtimeMediaDetailDataResponse, int, error
 */
func (p *Vod) DescribeVodRealtimeMediaDetailData(req *request.DescribeVodRealtimeMediaDetailDataRequest) (*response.DescribeVodRealtimeMediaDetailDataResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("DescribeVodRealtimeMediaDetailData", query)

	output := &response.DescribeVodRealtimeMediaDetailDataResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
 ...
 * @return *response.DescribeVodVidTrafficFileLogResponse, int, error
 */
func (p *Vod) DescribeVodVidTrafficFileLog(req *request.DescribeVodVidTrafficFileLogRequest) (*response.DescribeVodVidTrafficFileLogResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("DescribeVodVidTrafficFileLog", query)

	output := &response.DescribeVodVidTrafficFileLogResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
