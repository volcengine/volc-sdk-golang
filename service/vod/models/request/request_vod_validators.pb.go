...
func (req *VodCreateVideoClassificationRequest) Validate() (privateErrorCodeStr string, err error) {

	return
}
func (req *VodUpdateVideoClassificationRequest) Validate() (privateErrorCodeStr string, err error) {

	return
}
func (req *VodDeleteVideoClassificationRequest) Validate() (privateErrorCodeStr string, err error) {

	return
}
func (req *VodListVideoClassificationsRequest) Validate() (privateErrorCodeStr string, err error) {
