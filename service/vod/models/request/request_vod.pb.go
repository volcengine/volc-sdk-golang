...
type VodGetAllPlayInfoRequest struct {
	...
	KeyFrameAlignmentVersion string `protobuf:"bytes,15,opt,name=KeyFrameAlignmentVersion,proto3" json:"KeyFrameAlignmentVersion,omitempty"` // 使用的帧对齐转码版本
}
...
var file_vod_request_request_vod_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x22, 0x53, 0x0a, 0x21, 0x56, 0x6f, 0x64, 0x41, 0x64, 0x64, 0x43, 0x61, 0x6c, 0x6c,
