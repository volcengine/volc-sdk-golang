...
type VodGetAllPlayInfoRequest struct {
	...
	Formats string `protobuf:"bytes,2,opt,name=Formats,proto3" json:"Formats,omitempty"` //封装格式，支持 mp4、dash、hls、mp3、m4a、ogg。 多个
	// Format 组成的字符串，中间用","隔开。默认获取全部
	Codecs string `protobuf:"bytes,3,opt,name=Codecs,proto3" json:"Codecs,omitempty"` //编码格式，支持 mp3、aac、opus、H264、H265、H266 。 多个
	// Codec 组成的字符串，中间用","隔开。默认获取全部
	Definitions string `protobuf:"bytes,4,opt,name=Definitions,proto3" json:"Definitions,omitempty"` //视频流清晰度，默认返回全部，支持：240p，360p，480p，540p，720p，1080p。
	//多个 Codec 组成的字符串，中间用","隔开。默认获取全部
	FileTypes string `protobuf:"bytes,5,opt,name=FileTypes,proto3" json:"FileTypes,omitempty"` //视频流清晰度，默认返回全部，支持："video": 加密视频流, "audio":
	//普通音频音频流。 多个 FileType 组成的字符串，中间用","隔开
	LogoTypes         string `protobuf:"bytes,6,opt,name=LogoTypes,proto3" json:"LogoTypes,omitempty"`                 // 水印贴片标签
	NeedEncryptStream string `protobuf:"bytes,7,opt,name=NeedEncryptStream,proto3" json:"NeedEncryptStream,omitempty"` // 是否加密, 支持: "encrypt" : 加密流, "normal"
	// : 非加密流, 默认返回全部
	...
	KeyFrameAlignmentVersion string `protobuf:"bytes,16,opt,name=KeyFrameAlignmentVersion,proto3" json:"KeyFrameAlignmentVersion,omitempty"` // 使用的帧对齐转码版本。支持: "1" -
	// 返回版本一, 默认没指定版本，全部返回
	UserAction string `protobuf:"bytes,17,opt,name=UserAction,proto3" json:"UserAction,omitempty"` // 发布状态, 支持: "Available" : 发布, "NoAction" :
	// 未发布, 默认返回全部
	Quality string `protobuf:"bytes,18,opt,name=Quality,proto3" json:"Quality,omitempty"` // 音频音质。当 FileType 为 audio
}
...
var file_vod_request_request_vod_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x55, 0x0a, 0x21, 0x56, 0x6f, 0x64, 0x52,
	...
	0x66, 0x69, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x34, 0x0a, 0x14, 0x56, 0x6f, 0x64, 0x4c,
	...
	0x53, 0x6f, 0x72, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0xca, 0x01, 0x0a, 0x28, 0x56, 0x6f, 0x64,
	...
	0x68, 0x54, 0x79, 0x70, 0x65, 0x22, 0xd2, 0x01, 0x0a, 0x1a, 0x56, 0x6f, 0x64, 0x4c, 0x69, 0x73,
	...
	0x28, 0x09, 0x52, 0x06, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x22, 0xd3, 0x01, 0x0a, 0x1b, 0x56,
	...
	0x49, 0x70, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x49, 0x70, 0x73, 0x22, 0xb7,
	...
	0x45, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x1a, 0x0a, 0x08,
	0x44, 0x61, 0x74, 0x61, 0x54, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x44, 0x61, 0x74, 0x61, 0x54, 0x79, 0x70, 0x65, 0x22, 0x53, 0x0a, 0x21, 0x56, 0x6f, 0x64, 0x41,
	...
	0x72, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x55, 0x72, 0x6c, 0x22, 0x94, 0x01,
	...
	0x52, 0x0d, 0x48, 0x44, 0x52, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x42,
...
var file_vod_request_request_vod_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
var file_vod_request_request_vod_proto_goTypes = []interface{}{
	...
	(*VodCreateSpaceRequest)(nil),                           // 36: Volcengine.Vod.Models.Request.VodCreateSpaceRequest
	(*VodGetSpaceDetailRequest)(nil),                        // 37: Volcengine.Vod.Models.Request.VodGetSpaceDetailRequest
	(*VodListSpaceRequest)(nil),                             // 38: Volcengine.Vod.Models.Request.VodListSpaceRequest
	(*VodUpdateSpaceRequest)(nil),                           // 39: Volcengine.Vod.Models.Request.VodUpdateSpaceRequest
	(*VodUpdateSpaceUploadConfigRequest)(nil),               // 40: Volcengine.Vod.Models.Request.VodUpdateSpaceUploadConfigRequest
	(*VodListDomainRequest)(nil),                            // 41: Volcengine.Vod.Models.Request.VodListDomainRequest
	(*VodCreateCdnRefreshTaskRequest)(nil),                  // 42: Volcengine.Vod.Models.Request.VodCreateCdnRefreshTaskRequest
	(*VodCreateCdnPreloadTaskRequest)(nil),                  // 43: Volcengine.Vod.Models.Request.VodCreateCdnPreloadTaskRequest
	(*VodListCdnTasksRequest)(nil),                          // 44: Volcengine.Vod.Models.Request.VodListCdnTasksRequest
	(*VodListCdnAccessLogRequest)(nil),                      // 45: Volcengine.Vod.Models.Request.VodListCdnAccessLogRequest
	(*VodListCdnTopAccessUrlRequest)(nil),                   // 46: Volcengine.Vod.Models.Request.VodListCdnTopAccessUrlRequest
	(*VodDescribeVodDomainBandwidthDataRequest)(nil),        // 47: Volcengine.Vod.Models.Request.VodDescribeVodDomainBandwidthDataRequest
	(*VodListCdnUsageDataRequest)(nil),                      // 48: Volcengine.Vod.Models.Request.VodListCdnUsageDataRequest
	(*VodListCdnStatusDataRequest)(nil),                     // 49: Volcengine.Vod.Models.Request.VodListCdnStatusDataRequest
	(*VodDescribeIPInfoRequest)(nil),                        // 50: Volcengine.Vod.Models.Request.VodDescribeIPInfoRequest
	(*VodListCdnPvDataRequest)(nil),                         // 51: Volcengine.Vod.Models.Request.VodListCdnPvDataRequest
	(*VodAddCallbackSubscriptionRequest)(nil),               // 52: Volcengine.Vod.Models.Request.VodAddCallbackSubscriptionRequest
	(*VodSetCallbackEventRequest)(nil),                      // 53: Volcengine.Vod.Models.Request.VodSetCallbackEventRequest
	(*VodGetSmartStrategyLitePlayInfoRequest)(nil),          // 54: Volcengine.Vod.Models.Request.VodGetSmartStrategyLitePlayInfoRequest
	(*business.VodUrlUploadURLSet)(nil),                     // 55: Volcengine.Vod.Models.Business.VodUrlUploadURLSet
	(*wrapperspb.StringValue)(nil),                          // 56: google.protobuf.StringValue
	(*wrapperspb.Int64Value)(nil),                           // 57: google.protobuf.Int64Value
	(*business.WorkflowParams)(nil),                         // 58: Volcengine.Vod.Models.Business.WorkflowParams
}
var file_vod_request_request_vod_proto_depIdxs = []int32{
	55, // 0: Volcengine.Vod.Models.Request.VodUrlUploadRequest.URLSets:type_name -> Volcengine.Vod.Models.Business.VodUrlUploadURLSet
	56, // 1: Volcengine.Vod.Models.Request.VodUpdateMediaInfoRequest.PosterUri:type_name -> google.protobuf.StringValue
	56, // 2: Volcengine.Vod.Models.Request.VodUpdateMediaInfoRequest.Title:type_name -> google.protobuf.StringValue
	56, // 3: Volcengine.Vod.Models.Request.VodUpdateMediaInfoRequest.Description:type_name -> google.protobuf.StringValue
	56, // 4: Volcengine.Vod.Models.Request.VodUpdateMediaInfoRequest.Tags:type_name -> google.protobuf.StringValue
	57, // 5: Volcengine.Vod.Models.Request.VodUpdateMediaInfoRequest.ClassificationId:type_name -> google.protobuf.Int64Value
	56, // 6: Volcengine.Vod.Models.Request.VodUpdateSubtitleInfoRequest.Title:type_name -> google.protobuf.StringValue
	56, // 7: Volcengine.Vod.Models.Request.VodUpdateSubtitleInfoRequest.Tag:type_name -> google.protobuf.StringValue
	58, // 8: Volcengine.Vod.Models.Request.VodStartWorkflowRequest.Input:type_name -> Volcengine.Vod.Models.Business.WorkflowParams
