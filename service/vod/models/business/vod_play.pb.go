...
type VodIntertrustDrmPlayAuthInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *VodIntertrustDrmPlayAuthInfo) Reset() {
	*x = VodIntertrustDrmPlayAuthInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *VodIntertrustDrmPlayAuthInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VodIntertrustDrmPlayAuthInfo) ProtoMessage() {}

func (x *VodIntertrustDrmPlayAuthInfo) ProtoReflect() protoreflect.Message {
	mi := &file_vod_business_vod_play_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VodIntertrustDrmPlayAuthInfo.ProtoReflect.Descriptor instead.
func (*VodIntertrustDrmPlayAuthInfo) Descriptor() ([]byte, []int) {
	return file_vod_business_vod_play_proto_rawDescGZIP(), []int{3}
}

func (x *VodIntertrustDrmPlayAuthInfo) GetPlayAuthId() string {
	if x != nil {
		return x.PlayAuthId
	}
	return ""
...
func (x *VodIntertrustDrmPlayAuthInfo) GetPlayAuthContent() string {
	if x != nil {
		return x.PlayAuthContent
	}
	return ""
...
type VodGetIntertrustDrmPlayAuthResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PlayAuthInfoList []*VodIntertrustDrmPlayAuthInfo `protobuf:"bytes,1,rep,name=PlayAuthInfoList,proto3" json:"PlayAuthInfoList,omitempty"` // 播放许可信息列表
}

func (x *VodGetIntertrustDrmPlayAuthResult) Reset() {
	*x = VodGetIntertrustDrmPlayAuthResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vod_business_vod_play_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *VodGetIntertrustDrmPlayAuthResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VodGetIntertrustDrmPlayAuthResult) ProtoMessage() {}

func (x *VodGetIntertrustDrmPlayAuthResult) ProtoReflect() protoreflect.Message {
	mi := &file_vod_business_vod_play_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VodGetIntertrustDrmPlayAuthResult.ProtoReflect.Descriptor instead.
func (*VodGetIntertrustDrmPlayAuthResult) Descriptor() ([]byte, []int) {
	return file_vod_business_vod_play_proto_rawDescGZIP(), []int{6}
}

func (x *VodGetIntertrustDrmPlayAuthResult) GetPlayAuthInfoList() []*VodIntertrustDrmPlayAuthInfo {
	if x != nil {
		return x.PlayAuthInfoList
	}
	return nil
...
var file_vod_business_vod_play_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x05, 0x0a,
	...
	0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x56, 0x6f, 0x6c, 0x63, 0x65,
	...
	0x74, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xba, 0x02, 0x0a, 0x1c,
	...
	,
	...
	0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x2e, 0x56, 0x6f, 0x64, 0x50, 0x72, 0x69, 0x76, 0x61,
	0x74, 0x65, 0x44, 0x72, 0x6d, 0x50, 0x6c, 0x61, 0x79, 0x41, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x10, 0x50, 0x6c, 0x61, 0x79, 0x41, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x4c,
	0x69, 0x73, 0x74, 0x22, 0x3c, 0x0a, 0x1c, 0x56, 0x6f, 0x64, 0x47, 0x65, 0x74, 0x48, 0x6c, 0x73,
	...
	0x79, 0x22, 0x8d, 0x01, 0x0a, 0x21, 0x56, 0x6f, 0x64, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x74, 0x65,
	0x72, 0x74, 0x72, 0x75, 0x73, 0x74, 0x44, 0x72, 0x6d, 0x50, 0x6c, 0x61, 0x79, 0x41, 0x75, 0x74,
	0x68, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x68, 0x0a, 0x10, 0x50, 0x6c, 0x61, 0x79, 0x41,
	0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28,
	...
	0x73, 0x73, 0x2e, 0x56, 0x6f, 0x64, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x74, 0x72, 0x75, 0x73, 0x74,
	0x44, 0x72, 0x6d, 0x50, 0x6c, 0x61, 0x79, 0x41, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x52,
	0x10, 0x50, 0x6c, 0x61, 0x79, 0x41, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73,
	0x74, 0x2a, 0xd6, 0x01, 0x0a, 0x17, 0x56, 0x6f, 0x64, 0x50, 0x6c, 0x61, 0x79, 0x49, 0x6e, 0x66,
	...
	0x31, 0x56, 0x6f, 0x64, 0x50, 0x6c, 0x61, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x6f, 0x64, 0x65,
	0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x10, 0x04, 0x42, 0xcb, 0x01, 0x0a, 0x29, 0x63,
	...
	0x62, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x42, 0x07, 0x56, 0x6f, 0x64, 0x50, 0x6c, 0x61,
	0x79, 0x50, 0x01, 0x5a, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
var file_vod_business_vod_play_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_vod_business_vod_play_proto_goTypes = []interface{}{
	...
	(*VodIntertrustDrmPlayAuthInfo)(nil),      // 4: Volcengine.Vod.Models.Business.VodIntertrustDrmPlayAuthInfo
	(*VodGetPrivateDrmPlayAuthResult)(nil),    // 5: Volcengine.Vod.Models.Business.VodGetPrivateDrmPlayAuthResult
	(*VodGetHlsDecryptionKeyResult)(nil),      // 6: Volcengine.Vod.Models.Business.VodGetHlsDecryptionKeyResult
	(*VodGetIntertrustDrmPlayAuthResult)(nil), // 7: Volcengine.Vod.Models.Business.VodGetIntertrustDrmPlayAuthResult
	(*VodAdaptiveInfo)(nil),                   // 8: Volcengine.Vod.Models.Business.VodAdaptiveInfo
	(*VodPlayInfo)(nil),                       // 9: Volcengine.Vod.Models.Business.VodPlayInfo
	(*VodThumbInfo)(nil),                      // 10: Volcengine.Vod.Models.Business.VodThumbInfo
	(*VodSubtitleInfo)(nil),                   // 11: Volcengine.Vod.Models.Business.VodSubtitleInfo
}
var file_vod_business_vod_play_proto_depIdxs = []int32{
	...
	8,  // 1: Volcengine.Vod.Models.Business.VodPlayInfoModel.AdaptiveInfo:type_name -> Volcengine.Vod.Models.Business.VodAdaptiveInfo
	9,  // 2: Volcengine.Vod.Models.Business.VodPlayInfoModel.PlayInfoList:type_name -> Volcengine.Vod.Models.Business.VodPlayInfo
	10, // 3: Volcengine.Vod.Models.Business.VodPlayInfoModel.ThumbInfoList:type_name -> Volcengine.Vod.Models.Business.VodThumbInfo
	11, // 4: Volcengine.Vod.Models.Business.VodPlayInfoModel.SubtitleInfoList:type_name -> Volcengine.Vod.Models.Business.VodSubtitleInfo
	3,  // 5: Volcengine.Vod.Models.Business.VodGetPrivateDrmPlayAuthResult.PlayAuthInfoList:type_name -> Volcengine.Vod.Models.Business.VodPrivateDrmPlayAuthInfo
	4,  // 6: Volcengine.Vod.Models.Business.VodGetIntertrustDrmPlayAuthResult.PlayAuthInfoList:type_name -> Volcengine.Vod.Models.Business.VodIntertrustDrmPlayAuthInfo
...
func file_vod_business_vod_play_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vod_business_vod_play_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VodIntertrustDrmPlayAuthInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vod_business_vod_play_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VodGetIntertrustDrmPlayAuthResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
