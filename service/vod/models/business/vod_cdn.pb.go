...
type VodContentInfo struct {
	...
	CreateTime float64 `protobuf:"fixed64,5,opt,name=CreateTime,proto3" json:"CreateTime,omitempty"` //任务创建时间
...
func (x *VodContentInfo) GetCreateTime() float64 {
	if x != nil {
		return x.CreateTime
	}
	return 0
...
var file_vod_business_vod_cdn_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x73, 0x42, 0xca, 0x01, 0x0a, 0x29, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x6f, 0x6c, 0x63,
