...
type VodCdnAccessLogElement struct {
	...
	StartTimestamp float64 `protobuf:"fixed64,4,opt,name=StartTimestamp,proto3" json:"StartTimestamp,omitempty"` // 日志包起始时间，单位：Unix秒级时间戳
	EndTimestamp   float64 `protobuf:"fixed64,5,opt,name=EndTimestamp,proto3" json:"EndTimestamp,omitempty"`     // 日志包结束时间，单位：Unix秒级时间戳
}
...
func (x *VodCdnAccessLogElement) GetStartTimestamp() float64 {
	if x != nil {
...
func (x *VodCdnAccessLogElement) GetEndTimestamp() float64 {
	if x != nil {
...
type VodListCdnAccessLogResult struct {
	...
	InvalidDomainList []string               `protobuf:"bytes,2,rep,name=InvalidDomainList,proto3" json:"InvalidDomainList,omitempty"` // 没有权限的域名
}
...
func (x *VodListCdnAccessLogResult) GetInvalidDomainList() []string {
	if x != nil {
		return x.InvalidDomainList
	}
	return nil
}
...
var file_vod_business_vod_cdn_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0e, 0x53, 0x74,
	...
	0x28, 0x01, 0x52, 0x0c, 0x45, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	...
	0x74, 0x22, 0x92, 0x01, 0x0a, 0x19, 0x56, 0x6f, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x64, 0x6e,
	...
	0x66, 0x6f, 0x52, 0x04, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x2c, 0x0a, 0x11, 0x49, 0x6e, 0x76, 0x61,
	0x6c, 0x69, 0x64, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x11, 0x49, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x44, 0x6f, 0x6d, 0x61,
	0x69, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x42, 0xca, 0x01, 0x0a, 0x29, 0x63, 0x6f, 0x6d, 0x2e, 0x76,
...
var file_vod_business_vod_cdn_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_vod_business_vod_cdn_proto_goTypes = []interface{}{
	...
	(*VodCdnAccessLogElement)(nil),    // 6: Volcengine.Vod.Models.Business.VodCdnAccessLogElement
	(*VodCdnAccessLogInfo)(nil),       // 7: Volcengine.Vod.Models.Business.VodCdnAccessLogInfo
	(*VodListCdnAccessLogResult)(nil), // 8: Volcengine.Vod.Models.Business.VodListCdnAccessLogResult
}
var file_vod_business_vod_cdn_proto_depIdxs = []int32{
	...
	6, // 6: Volcengine.Vod.Models.Business.VodCdnAccessLogInfo.LogList:type_name -> Volcengine.Vod.Models.Business.VodCdnAccessLogElement
	7, // 7: Volcengine.Vod.Models.Business.VodListCdnAccessLogResult.Logs:type_name -> Volcengine.Vod.Models.Business.VodCdnAccessLogInfo
