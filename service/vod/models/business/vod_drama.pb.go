...
type DramaRecapConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AutoGenerateRecapText *bool    `protobuf:"varint,1,opt,name=AutoGenerateRecapText,proto3,oneof" json:"AutoGenerateRecapText,omitempty"`
	HasHardSubtitle       *bool    `protobuf:"varint,2,opt,name=HasHardSubtitle,proto3,oneof" json:"HasHardSubtitle,omitempty"`
	RecapTextLength       *int32   `protobuf:"varint,3,opt,name=RecapTextLength,proto3,oneof" json:"RecapTextLength,omitempty"`
	RecapStyle            *string  `protobuf:"bytes,4,opt,name=RecapStyle,proto3,oneof" json:"RecapStyle,omitempty"`
	RecapTextSpeed        *float64 `protobuf:"fixed64,5,opt,name=RecapTextSpeed,proto3,oneof" json:"RecapTextSpeed,omitempty"`
	AllowRepeatMatch      *bool    `protobuf:"varint,6,opt,name=AllowRepeatMatch,proto3,oneof" json:"AllowRepeatMatch,omitempty"`
	PauseTime             *int32   `protobuf:"varint,7,opt,name=PauseTime,proto3,oneof" json:"PauseTime,omitempty"`
}

func (x *DramaRecapConfig) Reset() {
	*x = DramaRecapConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_volcengine_vod_business_vod_drama_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DramaRecapConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DramaRecapConfig) ProtoMessage() {}

func (x *DramaRecapConfig) ProtoReflect() protoreflect.Message {
	mi := &file_volcengine_vod_business_vod_drama_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DramaRecapConfig.ProtoReflect.Descriptor instead.
func (*DramaRecapConfig) Descriptor() ([]byte, []int) {
	return file_volcengine_vod_business_vod_drama_proto_rawDescGZIP(), []int{6}
}

func (x *DramaRecapConfig) GetAutoGenerateRecapText() bool {
	if x != nil && x.AutoGenerateRecapText != nil {
		return *x.AutoGenerateRecapText
	}
	return false
}

func (x *DramaRecapConfig) GetHasHardSubtitle() bool {
...
func (x *DramaRecapConfig) GetRecapTextLength() int32 {
	if x != nil && x.RecapTextLength != nil {
		return *x.RecapTextLength
	}
	return 0
}

func (x *DramaRecapConfig) GetRecapStyle() string {
	if x != nil && x.RecapStyle != nil {
		return *x.RecapStyle
	}
	return ""
}

func (x *DramaRecapConfig) GetRecapTextSpeed() float64 {
	if x != nil && x.RecapTextSpeed != nil {
		return *x.RecapTextSpeed
	}
	return 0
}

func (x *DramaRecapConfig) GetAllowRepeatMatch() bool {
	if x != nil && x.AllowRepeatMatch != nil {
		return *x.AllowRepeatMatch
	}
	return false
}

func (x *DramaRecapConfig) GetPauseTime() int32 {
	if x != nil && x.PauseTime != nil {
		return *x.PauseTime
	}
	return 0
}
...
var file_volcengine_vod_business_vod_drama_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x6e, 0x65, 0x73, 0x73, 0x42, 0x08, 0x56, 0x6f, 0x64, 0x44, 0x72, 0x61, 0x6d, 0x61, 0x50,
...
var file_volcengine_vod_business_vod_drama_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_volcengine_vod_business_vod_drama_proto_goTypes = []interface{}{
	...
	(*DramaRecapConfig)(nil),                     // 6: Volcengine.Vod.Models.Business.DramaRecapConfig
}
...
func file_volcengine_vod_business_vod_drama_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_volcengine_vod_business_vod_drama_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DramaRecapConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_volcengine_vod_business_vod_drama_proto_msgTypes[6].OneofWrappers = []interface{}{}
	type x struct{}
