...
type VodSubtitleInfo struct {
	...
	Format      string `protobuf:"bytes,4,opt,name=Format,proto3" json:"Format,omitempty"`            //字幕格式
	SubtitleId  string `protobuf:"bytes,5,opt,name=SubtitleId,proto3" json:"SubtitleId,omitempty"`    //字幕ID
	Title       string `protobuf:"bytes,6,opt,name=Title,proto3" json:"Title,omitempty"`              //字幕标题
	Tag         string `protobuf:"bytes,7,opt,name=Tag,proto3" json:"Tag,omitempty"`                  //字幕标签
	Status      string `protobuf:"bytes,8,opt,name=Status,proto3" json:"Status,omitempty"`            //字幕状态
	Source      string `protobuf:"bytes,9,opt,name=Source,proto3" json:"Source,omitempty"`            //字幕来源
	StoreUri    string `protobuf:"bytes,10,opt,name=StoreUri,proto3" json:"StoreUri,omitempty"`       //字幕uri
	SubtitleUrl string `protobuf:"bytes,11,opt,name=SubtitleUrl,proto3" json:"SubtitleUrl,omitempty"` //字幕url
	CreateTime  string `protobuf:"bytes,12,opt,name=CreateTime,proto3" json:"CreateTime,omitempty"`   //创建时间
	LanguageId  string `protobuf:"bytes,13,opt,name=LanguageId,proto3" json:"LanguageId,omitempty"`   //字幕语言ID
...
func (x *VodSubtitleInfo) GetLanguageId() string {
	if x != nil {
		return x.LanguageId
	}
	return ""
...
var file_vod_business_vod_common_proto_rawDesc = []byte{
	...
	0x53, 0x75, 0x62, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x49, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	0x6c, 0x2e, 0x62, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x42, 0x09, 0x56, 0x6f, 0x64, 0x43,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x50, 0x01, 0x5a, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_vod_business_vod_common_proto_goTypes = []interface{}{
	(*VodSourceInfo)(nil),      // 0: Volcengine.Vod.Models.Business.VodSourceInfo
	(*VodAudioStreamMeta)(nil), // 1: Volcengine.Vod.Models.Business.VodAudioStreamMeta
	(*VodVideoStreamMeta)(nil), // 2: Volcengine.Vod.Models.Business.VodVideoStreamMeta
	(*VodTranscodeInfo)(nil),   // 3: Volcengine.Vod.Models.Business.VodTranscodeInfo
	(*VodAdaptiveInfo)(nil),    // 4: Volcengine.Vod.Models.Business.VodAdaptiveInfo
	(*VodPlayInfo)(nil),        // 5: Volcengine.Vod.Models.Business.VodPlayInfo
	(*VodThumbInfo)(nil),       // 6: Volcengine.Vod.Models.Business.VodThumbInfo
	(*VodSubtitleInfo)(nil),    // 7: Volcengine.Vod.Models.Business.VodSubtitleInfo
}
var file_vod_business_vod_common_proto_depIdxs = []int32{
	2, // 0: Volcengine.Vod.Models.Business.VodTranscodeInfo.VideoStreamMeta:type_name -> Volcengine.Vod.Models.Business.VodVideoStreamMeta
	1, // 1: Volcengine.Vod.Models.Business.VodTranscodeInfo.AudioStreamMeta:type_name -> Volcengine.Vod.Models.Business.VodAudioStreamMeta
