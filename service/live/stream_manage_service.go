...
func (p *LIVE) DescribeLiveStreamInfoByPage(req *request.DescribeLiveStreamInfoByPageRequest) (*response.DescribeLiveStreamInfoByPageResponse, int, error) {
	...
	respBody, status, err := p.Query("DescribeLiveStreamInfoByPage", query)

	output := &response.DescribeLiveStreamInfoByPageResponse{}
...
func (p *LIVE) KillStream(req *request.KillStreamRequest) (*response.KillStreamResponse, int, error) {
	...
	respBody, status, err := p.Json("KillStream", url.Values{}, string(body))
	output := &response.KillStreamResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
...
func (p *LIVE) DescribeClosedStreamInfoByPage(req *request.DescribeClosedStreamInfoByPageRequest) (*response.DescribeClosedStreamInfoByPageResponse, int, error) {
	...
	respBody, status, err := p.Query("DescribeClosedStreamInfoByPage", query)

	output := &response.DescribeClosedStreamInfoByPageResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
...
func (p *LIVE) DescribeLiveStreamState(req *request.DescribeLiveStreamStateRequest) (*response.DescribeLiveStreamStateResponse, int, error) {
	...
	respBody, status, err := p.Query("DescribeLiveStreamState", query)

	output := &response.DescribeLiveStreamStateResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
...
func (p *LIVE) DescribeForbiddenStreamInfoByPage(req *request.DescribeForbiddenStreamInfoByPageRequest) (*response.DescribeForbiddenStreamInfoByPageResponse, int, error) {
	...
	respBody, status, err := p.Query("DescribeForbiddenStreamInfoByPage", query)

	fmt.Printf("respBody:%#v\n", respBody)
	output := &response.DescribeForbiddenStreamInfoByPageResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
