...
type IndicatorTag struct {
	...
	// 是否隐藏维度过滤，注意这个参数只有在质量概览模块有效
	HidenDimensionFilter *bool `json:"HidenDimensionFilter,omitempty"`
...
type ListRealTimePublicStreamInfo struct{}
type ListRealTimePublicStreamInfoQuery struct{}
...
type ListRealTimePublicStreamInfoReq struct {
	*ListRealTimePublicStreamInfoQuery
	*ListRealTimePublicStreamInfoBody
}
