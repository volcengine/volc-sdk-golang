...
func Test_ListOperationData(t *testing.T) {
	...
	param := &rtc_v20231101.ListOperationDataBody{}

	resp, statusCode, err := instance.ListOperationData(context.Background(), param)
