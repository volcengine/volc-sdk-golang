...
func Test_ListRealTimeQuality(t *testing.T) {
	...
	param := &rtc_v20231101.ListRealTimeQualityBody{}

	resp, statusCode, err := instance.ListRealTimeQuality(context.Background(), param)
