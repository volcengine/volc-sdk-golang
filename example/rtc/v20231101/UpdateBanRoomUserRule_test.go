...
func Test_UpdateBanRoomUserRule(t *testing.T) {
	...
	param := &rtc_v20231101.UpdateBanRoomUserRuleBody{}

	resp, statusCode, err := instance.UpdateBanRoomUserRule(context.Background(), param)
