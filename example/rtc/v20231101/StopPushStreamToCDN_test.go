...
func Test_StopPushStreamToCDN(t *testing.T) {
	...
	param := &rtc_v20231101.StopPushStreamToCDNBody{}

	resp, statusCode, err := instance.StopPushStreamToCDN(context.Background(), param)
