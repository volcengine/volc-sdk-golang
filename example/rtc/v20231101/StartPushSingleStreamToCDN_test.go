...
func Test_StartPushSingleStreamToCDN(t *testing.T) {
	...
	param := &rtc_v20231101.StartPushSingleStreamToCDNBody{}

	resp, statusCode, err := instance.StartPushSingleStreamToCDN(context.Background(), param)
