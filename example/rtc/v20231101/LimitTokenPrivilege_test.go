...
func Test_LimitTokenPrivilege(t *testing.T) {
	...
	param := &rtc_v20231101.LimitTokenPrivilegeBody{}

	resp, statusCode, err := instance.LimitTokenPrivilege(context.Background(), param)
