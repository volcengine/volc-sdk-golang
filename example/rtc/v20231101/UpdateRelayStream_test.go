...
func Test_UpdateRelayStream(t *testing.T) {
	...
	param := &rtc_v20231101.UpdateRelayStreamBody{}

	resp, statusCode, err := instance.UpdateRelayStream(context.Background(), param)
