...
func Test_WbTranscodeCreate(t *testing.T) {
	...
	param := &rtc_v20231101.WbTranscodeCreateBody{}

	resp, statusCode, err := instance.WbTranscodeCreate(context.Background(), param)
