...
func Test_ListOperationDistribution(t *testing.T) {
	...
	param := &rtc_v20201201.ListOperationDistributionBody{}

	resp, statusCode, err := instance.ListOperationDistribution(context.Background(), param)
