...
func Test_CreateFailRecoveryPolicy(t *testing.T) {
	...
	param := &rtc_v20201201.CreateFailRecoveryPolicyBody{}

	resp, statusCode, err := instance.CreateFailRecoveryPolicy(context.Background(), param)
