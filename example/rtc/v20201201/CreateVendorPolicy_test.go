...
func Test_CreateVendorPolicy(t *testing.T) {
	...
	param := &rtc_v20201201.CreateVendorPolicyBody{}

	resp, statusCode, err := instance.CreateVendorPolicy(context.Background(), param)
