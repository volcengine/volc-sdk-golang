...
func Test_UpdateFailRecoveryPolicy(t *testing.T) {
	...
	param := &rtc_v20201201.UpdateFailRecoveryPolicyBody{}

	resp, statusCode, err := instance.UpdateFailRecoveryPolicy(context.Background(), param)
