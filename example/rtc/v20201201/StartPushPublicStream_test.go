...
func Test_StartPushPublicStream(t *testing.T) {
	...
	param := &rtc_v20201201.StartPushPublicStreamBody{}

	resp, statusCode, err := instance.StartPushPublicStream(context.Background(), param)
