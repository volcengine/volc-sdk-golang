...
func Test_DeleteFailRecoveryPolicy(t *testing.T) {
	...
	param := &rtc_v20201201.DeleteFailRecoveryPolicyBody{}

	resp, statusCode, err := instance.DeleteFailRecoveryPolicy(context.Background(), param)
