...
func Test_UpdateVendorPolicy(t *testing.T) {
	...
	param := &rtc_v20201201.UpdateVendorPolicyBody{}

	resp, statusCode, err := instance.UpdateVendorPolicy(context.Background(), param)
