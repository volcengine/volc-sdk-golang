...
func Test_GetFailRecoveryPolicies(t *testing.T) {
	...
	param := &rtc_v20201201.GetFailRecoveryPoliciesBody{}

	resp, statusCode, err := instance.GetFailRecoveryPolicies(context.Background(), param)
