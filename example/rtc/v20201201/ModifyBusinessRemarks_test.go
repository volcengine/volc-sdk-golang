...
func Test_ModifyBusinessRemarks(t *testing.T) {
	...
	param := &rtc_v20201201.ModifyBusinessRemarksBody{}

	resp, statusCode, err := instance.ModifyBusinessRemarks(context.Background(), param)
