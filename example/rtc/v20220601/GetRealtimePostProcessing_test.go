...
func Test_GetRealtimePostProcessing(t *testing.T) {
	...
	param := &rtc_v20220601.GetRealtimePostProcessingQuery{}

	resp, statusCode, err := instance.GetRealtimePostProcessing(context.Background(), param)
