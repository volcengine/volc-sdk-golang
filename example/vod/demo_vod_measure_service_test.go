...
func Test_DescribeVodVidTrafficFileLog(t *testing.T) {
	// Create a VOD instance in the specified region.
	// instance := vod.NewInstanceWithRegion("cn-north-1")
	instance := vod.NewInstance()
	...
	query := &request.DescribeVodVidTrafficFileLogRequest{
		SpaceList: "your SpaceList",
		StartTime: "your StartTime",
		EndTime:   "your EndTime",
	}

	resp, status, err := instance.DescribeVodVidTrafficFileLog(query)
	fmt.Println(status)
	fmt.Println(err)
	fmt.Println(resp.String())
}
