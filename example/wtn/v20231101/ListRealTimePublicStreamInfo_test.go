package wtn_v20231101_test

import (
	"context"
	"encoding/json"
	wtn_v20231101 "github.com/volcengine/volc-sdk-golang/service/wtn/v20231101"
	"testing"

	"github.com/volcengine/volc-sdk-golang/base"
)

func Test_ListRealTimePublicStreamInfo(t *testing.T) {
	// 如果您想使用其他区域的实例,请使用 `NewInstanceWithRegion(区域名)` 显式指定区域
	instance := wtn_v20231101.NewInstance()
	...
	param := &wtn_v20231101.ListRealTimePublicStreamInfoBody{}

	resp, statusCode, err := instance.ListRealTimePublicStreamInfo(context.Background(), param)
