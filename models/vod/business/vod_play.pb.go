...
type VodGetHlsDrmSecretKeyResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *VodGetHlsDrmSecretKeyResult) Reset() {
	*x = VodGetHlsDrmSecretKeyResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *VodGetHlsDrmSecretKeyResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VodGetHlsDrmSecretKeyResult) ProtoMessage() {}

func (x *VodGetHlsDrmSecretKeyResult) ProtoReflect() protoreflect.Message {
	mi := &file_vod_business_vod_play_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VodGetHlsDrmSecretKeyResult.ProtoReflect.Descriptor instead.
func (*VodGetHlsDrmSecretKeyResult) Descriptor() ([]byte, []int) {
	return file_vod_business_vod_play_proto_rawDescGZIP(), []int{4}
}

func (x *VodGetHlsDrmSecretKeyResult) GetSecretKey() string {
	if x != nil {
		return x.SecretKey
	}
	return ""
...
var file_vod_business_vod_play_proto_rawDesc = []byte{
	...
	0x41, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x3b, 0x0a, 0x1b,
	0x56, 0x6f, 0x64, 0x47, 0x65, 0x74, 0x48, 0x6c, 0x73, 0x44, 0x72, 0x6d, 0x53, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x53,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x10, 0x04, 0x42, 0xab, 0x01, 0x0a, 0x21, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x6f, 0x6c, 0x63, 0x65,
...
var file_vod_business_vod_play_proto_goTypes = []interface{}{
	...
	(*VodGetHlsDrmSecretKeyResult)(nil),    // 5: Volcengine.Models.Vod.Business.VodGetHlsDrmSecretKeyResult
...
func file_vod_business_vod_play_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vod_business_vod_play_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VodGetHlsDrmSecretKeyResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
