...
type VodThumbInfo struct {
	...
	Interval                 int32    `protobuf:"varint,7,opt,name=Interval,proto3" json:"Interval,omitempty"`                                 // 显示图片时间周期
...
func (x *VodThumbInfo) GetInterval() int32 {
	if x != nil {
		return x.Interval
	}
	return 0
...
var file_vod_business_vod_common_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
