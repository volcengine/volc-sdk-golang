...
type VodGetPlayInfoRequest struct {
	...
	ThumbVersion string `protobuf:"bytes,9,opt,name=ThumbVersion,proto3" json:"ThumbVersion,omitempty"` // 返回雪碧图版本，默认V2，可选值：V1-单张图(旧版)、V2-多张图
}
...
func (x *VodGetPlayInfoRequest) GetThumbVersion() string {
	if x != nil {
		return x.ThumbVersion
	}
	return ""
}
...
var file_vod_request_request_vod_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa9, 0x02, 0x0a, 0x15, 0x56, 0x6f, 0x64, 0x47, 0x65, 0x74, 0x50, 0x6c, 0x61,
	...
	0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x53, 0x73, 0x6c, 0x12, 0x22, 0x0a, 0x0c, 0x54, 0x68,
	0x75, 0x6d, 0x62, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x54, 0x68, 0x75, 0x6d, 0x62, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x87,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x56, 0x69, 0x64, 0x73, 0x22, 0xd1, 0x01, 0x0a, 0x17,
